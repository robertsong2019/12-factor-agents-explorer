...
class TestActiveMode(unittest.TestCase):
    ...
    def test_store_sets_attributes(self):
        ...
        self.assertEqual(attrs["gen_ai.memory.operation"], "store")
        self.assertEqual(attrs["gen_ai.memory.type"], "episodic")
        self.assertEqual(attrs["gen_ai.memory.store"], "agent_memory_graph")
        self.assertEqual(attrs["gen_ai.memory.items_stored"], 3)
        self.assertEqual(attrs["gen_ai.memory.namespace"], "test_ns")
        self.assertEqual(attrs["gen_ai.memory.actor_id"], "agent_42")
    ...
    def test_search_sets_query_attrs(self):
        ...
        calls = self.mock_span.set_attribute.call_args_list
        attrs = {c.args[0]: c.args[1] for c in calls}
        self.assertEqual(attrs["gen_ai.memory.operation"], "search")
        self.assertEqual(attrs["gen_ai.memory.search.query"], "user preferences")
        self.assertEqual(attrs["gen_ai.memory.search.top_k"], 10)
        self.assertEqual(attrs["gen_ai.memory.search.min_score"], 0.75)
    ...
    def test_retrieve_sets_hit_attr(self):
        ...
        calls = self.mock_span.set_attribute.call_args_list
        attrs = {c.args[0]: c.args[1] for c in calls}
        self.assertEqual(attrs["gen_ai.memory.operation"], "retrieve")
        self.assertEqual(attrs["gen_ai.memory.items_retrieved"], 5)
        self.assertTrue(attrs["gen_ai.memory.hit"])
    ...
    def test_update_sets_keys(self):
        ...
        calls = self.mock_span.set_attribute.call_args_list
        attrs = {c.args[0]: c.args[1] for c in calls}
        self.assertEqual(attrs["gen_ai.memory.operation"], "update")
        self.assertEqual(attrs["gen_ai.memory.items_updated"], 2)
        self.assertEqual(attrs["gen_ai.memory.keys"], ["node_1", "node_2"])
    ...
    def test_delete_default_type(self):
        ...
        calls = self.mock_span.set_attribute.call_args_list
        attrs = {c.args[0]: c.args[1] for c in calls}
        self.assertEqual(attrs["gen_ai.memory.operation"], "delete")
        self.assertEqual(attrs["gen_ai.memory.type"], "short_term")
        self.assertEqual(attrs["gen_ai.memory.items_deleted"], 4)
    ...
    def test_custom_store_name(self):
        ...
        calls = self.mock_span.set_attribute.call_args_list
        attrs = {c.args[0]: c.args[1] for c in calls}
        self.assertEqual(attrs["gen_ai.memory.store"], "custom_backend")
    ...
    def test_none_values_not_set(self):
        ...
        self.assertNotIn("gen_ai.memory.search.min_score", attr_names)
    ...
    def test_span_name_format(self):
        """Span name should be 'gen_ai.memory.<operation>'."""
        import telemetry
        ...
        self.assertEqual(span_name, "gen_ai.memory.retrieve")
