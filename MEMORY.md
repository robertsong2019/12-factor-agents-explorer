...
| # | 项目 | Tests | 状态 |
|---|------|-------|------|
| 1 | agent-task-cli | 1485 | ✅ npm ready, F226 (226 features) |
...
- [ ] **amg: query_believed_as_of(tt, vt=None)** (#033) — TRUE bi-temporal: add transaction-time filter to existing query_as_of. `query_believed_as_of` + `temporal_delta(t1,t2)`. ~90 lines + ~25 tests. Research #045 ✅. [笔记](catalyst-research/exploration-notes/2026-08-03-bitemporal-query-agent-memory.md)
